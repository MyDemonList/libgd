class GDStructure {
    constructor(client, data, fills = GDStructure.FILLS, seperator = ":") {
        if (typeof data == "string")
            data = GDStructure.parseRaw(data, seperator);
    ...
    static parseMultilineRaw(data, seperator = ":", multilineSeparator = "|") {
        ...
        for (let item of data.split(multilineSeparator)) {
            ret.push(GDStructure.parseRaw(item, seperator));
        }
    }
}
